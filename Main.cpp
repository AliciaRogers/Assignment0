	...
	while (userInput != 'X') {
		if (userInput == 'H') {
			...
			while (side1 <= 0.00 || side1 > 3.4e38) {
				cout << "Length cannot be 0, negative, non-numeric, or out-of-range. Please enter a positive value." << endl;
			...
			while (side2 <= 0 || side2 > 3.4e38) {
				cout << "Length cannot be 0, negative, or non-numeric, or out-of-range. Please enter a positive value." << endl;
				cin.clear(); // clears error state if the user entered a string or char. https://cplusplus.com/forum/general/207458/
				cin.ignore(); // clears the input causing error from stream. https://cplusplus.com/forum/general/207458/
				cin >> side2;
			}
			...
			try {
				...
				cout << "Values entered are too large/long. Please try again." << endl;
			}
			...
			// ensures that value entered is positive
			while (height <= 0 || height > 3.4e38) {
				cout << "Length cannot be 0, negative, or non-numeric. Please enter a positive value." << endl;
				cin.clear(); // clears error state if the user entered a string or char. https://cplusplus.com/forum/general/207458/
				cin.ignore(); // clears the input causing error from stream. https://cplusplus.com/forum/general/207458/
				cin >> height;
			}
			...
			// gets command input from user again
